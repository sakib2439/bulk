...
//profile menu by Md. Asiful Islam Sakib
Route::get('/buffer-posting/', 'BufferPostingController@index')->name('buffer_posting');
Route::get('/buffer-posting/search/{data}', 'BufferPostingController@search');
